...
function MainAbout() {
  return (
    <WhiteBox>
      ...
      <StyledP>
        Twentiment is a single-purpose application that gives you a sentiment
        analysis of things you might be interested in based on what people are
        saying on Twitter. It uses <a>natural language processing (NLP)</a>{" "}
        technology behind-the-scenes to gauge whether the language used in a
