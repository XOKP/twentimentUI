...
function MainAbout() {
  return (
    <WhiteBox>
      <StyledP>
        Twentiment <i>(pronounced: hīn(d)-sīt-iz-twen(t)ē-twen(t)ē)</i> is an{" "}
        <a href="https://github.com/nameer-rizvi/twentimentUI" target="_blank">
      ...
      <StyledP>
        ...
        that match what you're interested in and run a sentiment analysis on it.
        What you end up seeing are the unfiltered results of the sentiment
        analysis, including: the overall sentiment score, the most popular
        positive & negative words that were said, and the actual list of tweets
        themselves (with their own scores and highlighted sentiments).
      </StyledP>
      ...
      <StyledP>
        ...
        is exactly what Twentiment is all about.
      </StyledP>
      <StyledP>
        <a href="https://winkjs.org/wink-sentiment/index.html" target="_blank">
          (Behind the scenes Twentiment leverages a package called winkJS as its
          sentiment analyzer. Feel free to check it out for more details.)
        </a>
      </StyledP>
    </WhiteBox>
  );
